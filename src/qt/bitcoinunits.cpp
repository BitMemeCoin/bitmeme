...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTM: return QString("Bitcoins");
    case mBTM: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTM: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
