...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 BTM
        ...
        # feeRate of 0.1 BTM / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 BTM / KB produces a total fee well above -maxtxfee
